...
function ProjectsComponent() {
    ...
    const printProjects = projects.map((project)=>{
        return(
            <div key={project.id} className='project-container border border-red-500'>
                {/* Sección con la información de cada proyecto */}
                <div className='project-information'>
                    <h3 className='project-title text-[1.2rem]'>{project.title}</h3>
                    <h4 className='project-description text-[#ddd]'>{project.description}</h4>
                    <a href={project.github} target='_blank' className='project-link bg-[#2b2e36] text-[1rem] rounded-[25px] flex flex-row w-30 gap-2 justify-center '><svg
                ...
                <div className='project-photo'>
                    <div className='project-img rounded-[15px]'>
    ...
    return (
        <div className='bg-[#1a1d23] w-full h-full text-white'>
            <div>
                <h2 className='projects-title text-[1.1rem] text-[#58C4DC]'>PROYECTOS</h2>
                <h3 className='projects-subtitle text-[1.3rem]'>Mis proyectos destacados</h3>
            </div>
